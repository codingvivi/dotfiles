...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;;; org-mode <built-in>
   `(org-level-1 ((,class (:foreground ,fg3       :weight bold))))
   `(org-level-2 ((,class (:foreground ,base0C   :weight bold))))
   `(org-level-3 ((,class (:foreground ,base09   :weight bold))))
   `(org-level-4 ((,class (:foreground "#fde695" :weight bold))))
   `(org-level-5 ((,class (:foreground "#ffd6e8"  :weight bold))))
   `(org-level-6 ((,class (:foreground "#fff8db"  :weight bold))))
   ...
   `(org-block-begin-line ((,class (:foreground ,base07 :background ,bg1))))
   `(org-block-end-line ((,class (:foreground ,base07 :background ,bg1))))
   `(org-code ((,class (:foreground ,base0B :background ,bg2))))
   `(org-todo ((,class (:foreground ,base0D))))
   `(org-done ((,class (:foreground ,comment))))
   `(org-headline-done ((,class (:foreground ,comment))))
   `(org-date ((,class (:foreground ,base0F))))
